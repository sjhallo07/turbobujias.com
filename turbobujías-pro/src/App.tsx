  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-orange-500/30 selection:text-orange-500 relative">
      <Helmet>
        ...
        <meta property="og:image" content={selectedProduct?.image || "https://ais-pre-ruhxsaai45qsklzh4kwhga-30201257932.us-east1.run.app/og-image.jpg"} />
        ...
        <meta name="twitter:image" content={selectedProduct?.image || "https://ais-pre-ruhxsaai45qsklzh4kwhga-30201257932.us-east1.run.app/og-image.jpg"} />
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Floating WhatsApp Action (FontAwesome Feature) */}
        <a 
          href="https://wa.me/584120000000" 
          target="_blank" 
          rel="noopener noreferrer"
          className="fixed bottom-24 right-6 z-[90] w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform md:bottom-10"
